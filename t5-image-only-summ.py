...
class MultiModalt5(T5PreTrainedModel):  # nn.Module
    def __init__(self,config_vision,config_text):
        ...
        # Encoder
        self.encoder = ViTModel.from_pretrained("google/vit-base-patch16-224", config=self.config_vision)
        # self.encoder = MultimodalEncoder(self.config_vision, self.config_text, self.text_model.encoder)
        
        # Decoder
        self.text_model = T5ForConditionalGeneration.from_pretrained('google/flan-t5-base', config=self.config_text) 
    ...
    def forward(self, pixel_values=None, decoder_input_ids=None, labels=None, encoder_outputs=None,**kwargs,):
...
def main():
    ...
    train_dataset = pd.read_json('/home/tongnian/data/mimic-cxr/train.json', lines=True)[['findings', 'impression','image']]
    val_dataset = pd.read_json('/home/tongnian/data/mimic-cxr/valid.json', lines=True)[['findings', 'impression','image']]
    test_dataset = pd.read_json('/home/tongnian/data/mimic-cxr/test.json', lines=True)[['findings', 'impression','image']]
    ...
    if MODE == 'train':
        ...
        for epoch in range(epochs):
            ...
            if val_rouge > best_val_rouge:
                ...
                exp_folder_path = "/home/tongnian/RadiologySumm/experiments/image-only"
